    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(blank=True, help_text='The slot machine associated with this test', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='machine_tests', to='slot_importer.slotmachine')),
