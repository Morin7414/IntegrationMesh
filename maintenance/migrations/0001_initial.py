    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='slot_importer.slotmachine')),
            ],
        ),
        migrations.CreateModel(
            name='LogicSeals',
            fields=[
                ...
                ('seal_removed_date', models.DateTimeField(blank=True, help_text='Date when the initial seal was removed by the technician.', null=True)),
                ...
                ('initial_seal_verified_by', models.ForeignKey(blank=True, help_text='Security user who verified the initial seal', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='initial_seal_verified_users', to=settings.AUTH_USER_MODEL)),
                ('new_seal_verified_by', models.ForeignKey(blank=True, help_text='Security user who verified the new seal', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='new_seal_verified_users', to=settings.AUTH_USER_MODEL)),
                ...
                ('technician_removed', models.ForeignKey(blank=True, help_text='Technician who removed the initial seal', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='technicians_removed_seals', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_user', models.ForeignKey(blank=True, help_text='Security user who performed the review', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='kobetron_security_users', to=settings.AUTH_USER_MODEL)),
