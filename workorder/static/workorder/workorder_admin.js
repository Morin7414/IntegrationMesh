...
(function($) {
    $(document).ready(function() {
        ...
        var previousValue = $('#id_slot_machine').val(); // Store the initial value
     
        // Function to check if the value of the text field has changed
        function checkForChange() {
            var currentValue = $('#id_slot_machine').val();
        ...
        function populateFields() {
            var machineId = $('#id_slot_machine').val();
            if (!machineId) {
                return;
            }
